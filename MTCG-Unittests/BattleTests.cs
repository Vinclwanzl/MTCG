...
namespace MTCG_Unittests
{
    ...
    public class BattleTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _player1 = new User("Player1", deck1);
            _player2 = new User("Player2", deck2);
        }
        ...
        public void Battle_Constructor_CreatesInstance()
        {
            ...
            Assert.AreEqual(_player1, battle.Player1);
            Assert.AreEqual(_player2, battle.Player2);
        ...
        {
            // Arrange
            Battle battle = new Battle(_player1, null);
        ...
        {
            // Arrange
            Battle battle = new Battle(null, _player2);
